...
public class BookingRepository : IBookingRepository
{
    ...
    public async Task<IEnumerable<Booking>> GetByUserEmailAsync(string email, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving bookings for user email: {Email} from database", email);
            throw;
        }
    }
    ...
    public async Task<bool> ExistsAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error checking existence of booking with ID: {BookingId} in database", id);
            throw;
        }
    }
    ...
    public async Task<IEnumerable<Booking>> SearchAsync(string searchTerm, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error searching bookings with term: {SearchTerm} in database", searchTerm);
            throw;
        }
    }
}
